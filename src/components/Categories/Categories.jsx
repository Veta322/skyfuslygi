...
function Categories() {
  return (
    <div className="categories">
      ...
      <Link to="/health" className="categories__el">
        <svg
          className="categories__el_icon"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <Link to="/pension" className="categories__el">
        <svg
          className="categories__el_icon"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <Link to="/auto" className="categories__el">
        <svg
          className="categories__el_icon"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
      ...
      <Link to="/house" className="categories__el">
        <svg
          className="categories__el_icon"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
